...
const char * LIB_PATH_VALUE   = "/var/lib/buildbot/curl/curl_winssl_cross_x86/build/lib/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/tmp/curl_winssl_cross_x86/libssh2/lib;/tmp/curl_winssl_cross_x86/libssh2/bin;/var/lib/buildbot/curl/curl_winssl_cross_x86/build/lib/.libs;/usr/i686-w64-mingw32/lib;/usr/i686-w64-mingw32/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/tmp/curl_winssl_cross_x86/libssh2/lib:/tmp/curl_winssl_cross_x86/libs", f);
  fputs ("sh2/bin:/var/lib/buildbot/curl/curl_winssl_cross_x86/build/lib/.libs:/usr/i686-", f);
  fputs ("w64-mingw32/lib:/usr/i686-w64-mingw32/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/var/lib/buildbot/curl/curl_winssl_cross_x86/build/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
