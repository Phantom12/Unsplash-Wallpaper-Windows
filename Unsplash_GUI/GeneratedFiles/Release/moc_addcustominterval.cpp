...
const QMetaObject addCustomInterval::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_addCustomInterval.data,
      qt_meta_data_addCustomInterval,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *addCustomInterval::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_addCustomInterval.stringdata0))
        return static_cast<void*>(const_cast< addCustomInterval*>(this));
    if (!strcmp(_clname, "Ui::addCustomInterval"))
        return static_cast< Ui::addCustomInterval*>(const_cast< addCustomInterval*>(this));
