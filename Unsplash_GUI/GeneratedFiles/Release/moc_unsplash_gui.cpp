...
QT_MOC_LITERAL(11, 182, 20), // "on_autoStart_clicked"
QT_MOC_LITERAL(12, 203, 17), // "trayMenuActivated"
QT_MOC_LITERAL(13, 221, 33), // "QSystemTrayIcon::ActivationRe..."
QT_MOC_LITERAL(14, 255, 6) // "reason"
...
QT_INIT_METAOBJECT const QMetaObject Unsplash_GUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Unsplash_GUI.data,
      qt_meta_data_Unsplash_GUI,  qt_static_metacall, nullptr, nullptr}
};
...
void *Unsplash_GUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "unsplash::Unsplash_Wei"))
        return static_cast< unsplash::Unsplash_Wei*>(this);
