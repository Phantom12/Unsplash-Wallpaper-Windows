...
QT_MOC_LITERAL(11, 186, 17), // "trayMenuActivated"
QT_MOC_LITERAL(12, 204, 33), // "QSystemTrayIcon::ActivationRe..."
QT_MOC_LITERAL(13, 238, 6) // "reason"
...
const QMetaObject Unsplash_GUI_old::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Unsplash_GUI_old.data,
      qt_meta_data_Unsplash_GUI_old,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Unsplash_GUI_old::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Unsplash_GUI_old.stringdata0))
        return static_cast<void*>(const_cast< Unsplash_GUI_old*>(this));
    if (!strcmp(_clname, "unsplash::Unsplash_Wei_old"))
        return static_cast< unsplash::Unsplash_Wei_old*>(const_cast< Unsplash_GUI_old*>(this));
