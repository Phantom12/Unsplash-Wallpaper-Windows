...
const char * LIB_PATH_VALUE   = "/var/lib/buildbot/curl/curl_winssl_cross_x64/build/lib/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/tmp/curl_winssl_cross_x64/libssh2/lib;/tmp/curl_winssl_cross_x64/libssh2/bin;/var/lib/buildbot/curl/curl_winssl_cross_x64/build/lib/.libs;/usr/x86_64-w64-mingw32/lib;/usr/x86_64-w64-mingw32/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"curl.exe:curl:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2", f);
  fputs (".4.2-1.11\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/tmp/curl_winssl_cross_x64/libssh2/lib:/tmp/curl_winssl_cross_x64/libs", f);
  fputs ("sh2/bin:/var/lib/buildbot/curl/curl_winssl_cross_x64/build/lib/.libs:/usr/x86_6", f);
  fputs ("4-w64-mingw32/lib:/usr/x86_64-w64-mingw32/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/var/lib/buildbot/curl/curl_winssl_cross_x64/build/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
